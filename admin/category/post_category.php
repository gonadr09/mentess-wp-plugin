...
<div class='wrap'>
    ...
    ?>
    <form method='post' name='category-post' id='category-post' class='validate' novalidate='novalidate'>
        ...
        <table class='form-table' role='presentation'>
            <tbody>
                <tr class='form-required'>
                    ...
                    <td><input class='regular-text' name='name' type='text' id='name' value='<?php echo esc_attr($category_name); ?>' aria-required='true' autocapitalize='none' autocorrect='off' autocomplete='off' maxlength='60'></td>
                </tr>
                <tr class='form-field'>
